  ...
  <div class="first-screen">
    <div class="left-screen">
      <div class="classification">
        <span class="classification-img"></span>
        商品分类
      </div>
...
.classification-img {
  ...
  background: url("../imgs/classification.png") no-repeat 100% 100%;
